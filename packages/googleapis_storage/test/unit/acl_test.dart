...
void main() {
  ...
  setUp(() {
    ...
    when(
      () => mockClient.bucketAccessControls,
    ).thenReturn(mockBucketAccessControls);
    when(
      () => mockClient.objectAccessControls,
    ).thenReturn(mockObjectAccessControls);
    when(
      () => mockClient.defaultObjectAccessControls,
  ...
  group('AclEntry', () {
    test('should create with required fields', () {
      const entry = AclEntry(entity: 'user-test@example.com', role: 'OWNER');
  ...
  group('Acl - Bucket ACL', () {
    ...
    group('add', () {
      test(
        'should call bucketAccessControls.insert with correct parameters',
        () async {
          ...
          when(
            () => mockBucketAccessControls.insert(
              any(),
              any(),
      ...
      test('should throw ApiError on failure', () async {
        ...
        expect(
          () => bucketAcl.add(entity: 'user-test@example.com', role: 'OWNER'),
    ...
    group('delete', () {
      test(
        'should call bucketAccessControls.delete with correct parameters',
        () async {
          when(
            () => mockBucketAccessControls.delete(
              any(),
              any(),
              userProject: any(named: 'userProject'),
            ),
    ...
    group('get', () {
      test(
        'should call bucketAccessControls.get with correct parameters',
        () async {
          final mockResponse = storage_v1.BucketAccessControl()
            ..entity = 'user-test@example.com'
            ..role = 'OWNER';
    ...
    group('getAll', () {
      test(
        'should call bucketAccessControls.list and return all entries',
        () async {
          ...
          verify(
            () =>
                mockBucketAccessControls.list('test-bucket', userProject: null),
          ).called(1);
      ...
      test('should throw ApiError on failure', () async {
        ...
        expect(() => bucketAcl.getAll(), throwsA(isA<ApiError>()));
      });
    });

    group('update', () {
      test(
        'should call bucketAccessControls.update with correct parameters',
        () async {
          final mockResponse = storage_v1.BucketAccessControl()
            ..entity = 'user-test@example.com'
            ..role = 'WRITER';
          ...
          when(
            () => mockBucketAccessControls.update(
              any(),
              any(),
              any(),
              userProject: any(named: 'userProject'),
  ...
  group('Acl - Bucket Default Object ACL', () {
    ...
    group('add', () {
      test('should call defaultObjectAccessControls.insert', () async {
        ...
        when(
          () => mockDefaultObjectAccessControls.insert(
            any(),
            any(),
            userProject: any(named: 'userProject'),
          ),
        ...
        verify(
          () => mockDefaultObjectAccessControls.insert(
            any(
              that: predicate<storage_v1.ObjectAccessControl>(
                (acl) =>
                    acl.entity == 'user-test@example.com' &&
                    acl.role == 'OWNER',
              ),
    ...
    group('delete', () {
      test('should call defaultObjectAccessControls.delete', () async {
        when(
          () => mockDefaultObjectAccessControls.delete(
            any(),
            any(),
            userProject: any(named: 'userProject'),
          ),
    ...
    group('get', () {
      test('should call defaultObjectAccessControls.get', () async {
        ...
        when(
          () => mockDefaultObjectAccessControls.get(
            any(),
            any(),
            userProject: any(named: 'userProject'),
          ),
        ...
        final result = await defaultObjectAcl.get(
          entity: 'user-test@example.com',
        );
    ...
    group('getAll', () {
      test('should call defaultObjectAccessControls.list', () async {
        ...
        when(
          () => mockDefaultObjectAccessControls.list(
            any(),
            userProject: any(named: 'userProject'),
          ),
        ).thenAnswer((_) async => mockResponse);
    ...
    group('update', () {
      test('should call defaultObjectAccessControls.update', () async {
        ...
        when(
          () => mockDefaultObjectAccessControls.update(
            any(),
            any(),
            any(),
            userProject: any(named: 'userProject'),
  ...
  group('Acl - Object ACL', () {
    ...
    group('add', () {
      test(
        'should call objectAccessControls.insert with correct parameters',
        () async {
          final mockResponse = storage_v1.ObjectAccessControl()
            ..entity = 'user-test@example.com'
            ..role = 'OWNER';
    ...
    group('delete', () {
      test('should call objectAccessControls.delete', () async {
        when(
          () => mockObjectAccessControls.delete(
            any(),
            any(),
            any(),
            generation: any(named: 'generation'),
    ...
    group('get', () {
      ...
      test('should pass generation parameter', () async {
        ...
        await objectAcl.get(entity: 'user-test@example.com', generation: 123);
    ...
    group('update', () {
      test('should call objectAccessControls.update', () async {
        ...
        when(
          () => mockObjectAccessControls.update(
            any(),
            any(),
            any(),
            any(),
      ...
      test('owners should add allUsers with OWNER role', () async {
        ...
        verify(
          () => mockBucketAccessControls.insert(
            any(
              that: predicate<storage_v1.BucketAccessControl>(
                (acl) => acl.entity == 'allUsers' && acl.role == 'OWNER',
              ),
            ),
            'test-bucket',
            userProject: null,
      ...
      test('readers should add allUsers with READER role', () async {
        ...
        verify(
          () => mockBucketAccessControls.insert(
            any(
              that: predicate<storage_v1.BucketAccessControl>(
                (acl) => acl.entity == 'allUsers' && acl.role == 'READER',
              ),
            ),
            'test-bucket',
            userProject: null,
        ...
        verify(
          () => mockBucketAccessControls.insert(
            any(
              that: predicate<storage_v1.BucketAccessControl>(
                (acl) =>
                    acl.entity == 'domain-example.com' && acl.role == 'OWNER',
              ),
            ),
            'test-bucket',
            userProject: null,
        ...
        verify(
          () => mockBucketAccessControls.insert(
            any(
              that: predicate<storage_v1.BucketAccessControl>(
                (acl) =>
                    acl.entity == 'project-project-id' && acl.role == 'OWNER',
              ),
            ),
            'test-bucket',
            userProject: null,
